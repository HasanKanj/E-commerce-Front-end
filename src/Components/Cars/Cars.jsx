          ...
          >
            ...
            <li className="nav-item" id="mercedes" >
              <span
                ...
                style={{
                  cursor: "pointer",
                  color: selectedCategory === "MERCEDES" ? "#8B0000" : "black",
                }}
              >
                Mercedes
              </span>
            ...
            <li className="nav-item">
              <span
                ...
                style={{
                  cursor: "pointer",
                  color: selectedCategory === "TOYOTA" ? "#8B0000" : "black",
                }}
              >
                Toyota
              </span>
            ...
            <li className="nav-item">
              <span
                ...
                style={{
                  cursor: "pointer",
                  color:
                    selectedCategory === "ELECTRIC CAR" ? "#8B0000" : "black",
                }}
              >
                Electric
              </span>
